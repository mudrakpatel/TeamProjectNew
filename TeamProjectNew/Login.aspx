<%@ Page Title="Login" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="TeamProjectNew.LoginSignUpPage" %>
            ...
            <div class="col-md-offset-4 col-md-4">
                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h1 class="panel-title"><i class="fa fa-sign-in fa-lg"></i>Login As Registered User</h1>
                    </div>
                    <br />
